...
type BlogService interface {
	...
	GetBySinceId(context.Context, int64, int, interface{}) ([]Blog, error)
...
func (s *BlogServiceOp) GetBySinceId(ctx context.Context, sinceId int64, limit int, options interface{}) ([]Blog, error) {
